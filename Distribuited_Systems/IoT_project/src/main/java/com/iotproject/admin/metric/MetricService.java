...
public class MetricService {
    ...
    public static void queryAggregatedMetrics(Scanner scanner) throws Exception {
        ...
        String start = getDateFromInput(scanner, "Início (opcional, formato yyyy-MM-dd HH:mm:ss):Deixe vazio para obter as ultimas 24horas", -24);
        String end = getDateFromInput(scanner, "Fim (opcional, formato yyyy-MM-dd HH:mm:ss): Deixe vazio para obter as ultimas 24horas", 0);
